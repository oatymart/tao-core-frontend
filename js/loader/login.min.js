...
buffer+='<span class="viewable-hiddenbox-toggle" tabindex="0"><span class="icon-preview"></span><span class="icon-eye-slash" style="display: none;"></span></span></span>'})});var theAnswer=require("theAnswer");console.log("a =",theAnswer),module.exports={theAnswer:theAnswer},define("npm-imports",[],function(){}),define("theAnswer",function(){}),define("controller/login",["jquery","lodash","i18n","module","layout/loading-bar","layout/version-warning","ui/login/login","theAnswer"],function($,_,__,module,loadingBar,versionWarning,loginComponent,theAnswer){"use strict";var _defaults={disableAutocomplete:!1,enablePasswordReveal:!1,message:{error:""}}
;return console.warn("a =",theAnswer),{start:function(){var conf=_.defaults({},module.config(),_defaults);loginComponent($("#login-box-inner-container"),conf).on("init",function(){loadingBar.start()}).after("render",function(){versionWarning.init(),loadingBar.stop()}).on("submit.login",function(){loadingBar.start()})}}}),define("loader/login.bundle",function(){});
