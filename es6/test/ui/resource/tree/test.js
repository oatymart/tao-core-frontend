 ...
 */
import $ from 'jquery';
import resourceTreeFactory from 'ui/resource/tree';
import rootData from 'json!test/ui/resource/tree/root.json';
import nodeData from 'json!test/ui/resource/tree/node.json';
