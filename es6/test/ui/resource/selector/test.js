...
import classesData from 'json!test/ui/resource/selector/classes.json';
import treeRootData from 'json!test/ui/resource/tree/root.json';
import treeNodeData from 'json!test/ui/resource/tree/node.json';
import listData from 'json!test/ui/resource/list/nodes.json';
