...
import selectable from 'ui/resource/selectable';
import hider from 'ui/hider';
import listTpl from 'tpl!ui/resource/tpl/list';
import listNodeTpl from 'tpl!ui/resource/tpl/listNode';
     ...
     */
    export default function resourceListFactory($container, config){
        var $list;
        var $loadMore;
