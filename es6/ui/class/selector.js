...
import selectorTpl from 'tpl!ui/class/tpl/selector';
import listItemTpl from 'tpl!ui/class/tpl/listItem';
import 'css!ui/class/css/selector.css';
     ...
     */
    export default function classesSelectorFactory($container, config){
        var $selected;
        var $options;
