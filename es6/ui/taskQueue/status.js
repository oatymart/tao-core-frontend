...
import statusTpl from 'tpl!ui/taskQueue/tpl/status';
import messageTpl from 'tpl!ui/taskQueue/tpl/statusMessage';
     ...
     * @returns {*}
     */
    export default function taskQueueStatusComponent(config) {
