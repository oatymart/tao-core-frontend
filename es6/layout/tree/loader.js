...
import jsTreeProvider from 'layout/tree/provider/jstree';
import resourceSelectorProvider from 'layout/tree/provider/resourceSelector';
     ...
     */
    export default function loadTree(providerName){
